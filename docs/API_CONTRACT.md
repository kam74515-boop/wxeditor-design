...
### 15.1 微信公众号 OAuth 登录 (Phase 1)

```
GET  /api/auth/wechat/authorize    # 获取微信授权URL
GET  /api/auth/wechat/callback     # 微信回调
POST /api/auth/wechat/bind         # 绑定微信账号
```

### 15.2 微信公众号管理 (Phase 2)

```
GET    /api/wechat/accounts/bind   # 获取绑定的公众号列表
POST   /api/wechat/accounts/bind   # 绑定公众号 (通过API)
DELETE /api/wechat/accounts/:id    # 解绑公众号
GET    /api/wechat/accounts/:id/info # 获取公众号信息
```

### 15.3 多图文消息 (Phase 2)

```
GET    /api/article-groups          # 图文组列表
POST   /api/article-groups          # 创建图文组
GET    /api/article-groups/:id      # 图文组详情
PUT    /api/article-groups/:id      # 更新图文组
DELETE /api/article-groups/:id      # 删除图文组
POST   /api/article-groups/:id/articles      # 添加文章到组
PUT    /api/article-groups/:id/articles/sort # 排序
DELETE /api/article-groups/:id/articles/:docId # 从组移除
POST   /api/article-groups/:id/publish       # 发布整个图文组
POST   /api/article-groups/:id/schedule      # 定时发布
```
...
GET    /api/schedules/:id/status   # 查询执行状态
```
...
PUT    /api/documents/:id/comments/:cid      # 更新评论
DELETE /api/documents/:id/comments/:cid      # 删除评论
POST   /api/documents/:id/comments/:cid/resolve  # 标记已解决
```
