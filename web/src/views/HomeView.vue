<template>
  <div class="home-layout">
    ...
    <nav class="topnav" :class="{ 'topnav--scrolled': scrolled }">
      ...
      <div class="topnav__right">
        <template v-if="userStore.isLoggedIn">
          <AppButton to="/projects" class="topnav__badge" size="sm" shape="pill">
            工作台
          </AppButton>
        </template>
        <template v-else>
          <router-link to="/login" class="topnav__item">登录</router-link>
          <AppButton to="/register" class="topnav__badge" size="sm" shape="pill">
            免费注册
          </AppButton>
        </template>
      </div>
    ...
    <transition name="mobile-nav">
      <div v-if="showMobileMenu" class="mobile-nav-overlay" @click.self="closeMobileMenu">
        <div class="mobile-nav-panel">
          <div class="mobile-nav-panel__header">
            ...
            <button class="mobile-nav-panel__close" type="button" aria-label="关闭导航菜单" @click="closeMobileMenu">
              <X :size="18" />
            </button>
          </div>

          <div class="mobile-nav-panel__group">
            <button class="mobile-nav-link" type="button" @click="handleMobileAnchorClick('features')">核心功能</button>
            <button class="mobile-nav-link" type="button" @click="handleMobileAnchorClick('workflow')">使用流程</button>
            <button class="mobile-nav-link" type="button" @click="handleMobileAnchorClick('pricing')">价格方案</button>
          </div>

          <div class="mobile-nav-panel__divider" />

          <div class="mobile-nav-panel__group">
            <template v-if="userStore.isLoggedIn">
              <router-link to="/projects" class="mobile-nav-link mobile-nav-link--primary" @click="closeMobileMenu">
                进入工作台
              </router-link>
              <router-link to="/editor" class="mobile-nav-link" @click="closeMobileMenu">
                新建文档
              </router-link>
            </template>
            <template v-else>
              ...
              <router-link to="/register" class="mobile-nav-link mobile-nav-link--primary" @click="closeMobileMenu">
                免费注册
              </router-link>
            </template>
          </div>
    ...
    <div class="home-content">
        ...
        <div class="hero-inner">
          <div class="hero-content">
            ...
            <div class="hero-actions">
              <AppButton to="/register" class="hero-btn" size="lg" shape="box">
                立即体验
              </AppButton>
              <AppButton class="hero-btn" variant="secondary" size="lg" shape="box" @click="scrollTo('features')">
                了解更多
              </AppButton>
            </div>
        ...
        <div class="pricing-desk">
           <div class="pricing-cards">
              <div class="pricing-card pricing-card--blue">
                ...
                <AppButton to="/register" class="pricing-btn" variant="secondary" size="lg" shape="box" block>
                  当前方案
                </AppButton>
              </div>
              ...
              <div class="pricing-card pricing-card--pink raise-up">
                ...
                <AppButton to="/register" class="pricing-btn" size="lg" shape="box" block>
                  立即升级
                </AppButton>
              </div>
              ...
              <div class="pricing-card pricing-card--purple">
                ...
                <AppButton to="/pricing" class="pricing-btn" variant="secondary" size="lg" shape="box" block>
                  联系我们
                </AppButton>
              </div>
           </div>
      ...
      <section class="cta-section">
        ...
        <AppButton to="/register" class="cta-btn" size="lg" shape="box">
          立即体验
          <template #trailing>
            <ArrowRight :size="16" />
          </template>
...
import { 
  ...
  Image as ImageIcon, MousePointer2, Type, FolderKey, Box, X
...
function handleMobileAnchorClick(id: string) {
  closeMobileMenu();
